...
export function RegionMap({ features, schools, mrkOverlays, mrkLocalities = [], municipalities = [], streetLines = [], housePoints = [], houseDots = [], coverageGaps = [], findings = [], districtSummaries = {}, initialMode = 'sk' }: RegionMapProps) {
